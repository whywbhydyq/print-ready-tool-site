...
const description = 'Free print-ready and image-size tools for pixels, DPI, bleed, safe zones, KDP covers, Etsy printables, and PixelFit creator overlays.';
export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: { default: 'Print Ready Tools | DPI, Bleed, KDP and PixelFit Calculators', template: '%s | Print Ready Tools' },
  description,
