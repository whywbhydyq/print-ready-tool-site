...
export const guides = [
  ...
  ['/guides/kdp-6x9-120-page-cover-size/', 'KDP 6x9 Cover Size for 120 Pages', 'Preset 6x9 paperback cover dimensions for 120 black-and-white pages.'],
  ['/guides/kdp-5-5x8-5-200-page-cover-size/', 'KDP 5.5x8.5 Cover Size for 200 Pages', 'Preset 5.5x8.5 cream-paper paperback cover dimensions for 200 pages.'],
  ['/guides/kdp-8-5x11-120-page-workbook-cover-size/', 'KDP 8.5x11 Workbook Cover Size for 120 Pages', 'Preset 8.5x11 standard-color workbook cover dimensions for 120 pages.'],
